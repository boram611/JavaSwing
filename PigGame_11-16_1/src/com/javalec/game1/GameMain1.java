...
//				Timer();
		...
		if (lblExit == null) {
			...
			lblExit.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					if(
					JOptionPane.showConfirmDialog(null, "돼지력 테스트 게임을 종료 하시겠습니까?", " ", 2, JOptionPane.YES_NO_OPTION, icon) == 0) {
	...
	private JLabel getLblNewLabel() {
		if (lblNewLabel == null) {
			lblNewLabel = new JLabel("돼지력 테스트 퀴즈");
	...
	private JLabel getLblNewLabel_1() {
		if (lblNewLabel_1 == null) {
			lblNewLabel_1 = new JLabel("사진을 보고 어떤 음식인지 맞춰보세요!");
...
//		}
    ...
    public void RankPig1st () {
		try{
			...
			PanelGame1.lbl1st.setText(id + "님\t\t\t\t" + pig_score + " 점");
	...
	public void RankPig2nd () {
		try{
			...
			PanelGame1.lbl2nd.setText(id + "님\t\t\t\t" + pig_score + " 점");
	...
	public void RankPig3rd () {
		try{
			...
			PanelGame1.lbl3rd.setText(id + "님\t\t\t\t" + pig_score + " 점");
	...
	public void RankPig4th () {
		try{
			...
			PanelGame1.lbl4th.setText(id + "님\t\t\t\t" + pig_score + " 점");
	...
	public void RankPig5th () {
		try{
			...
			PanelGame1.lbl5th.setText(id + "님\t\t\t\t" + pig_score + " 점");
