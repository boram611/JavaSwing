...
public class GameRul1 extends JFrame {
		...
		if (lblExit == null) {
			...
			lblExit.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					if(
					JOptionPane.showConfirmDialog(null, "돼지력 테스트 게임 방법 창을 닫으시겠습니까?", " ", 2, JOptionPane.YES_NO_OPTION, icon) == 0) {
	...
	private JLabel getLblNewLabel_1() {
		if (lblNewLabel_1 == null) {
			lblNewLabel_1 = new JLabel("돼지력 테스트 게임 방법");
	...
	private JLabel getLblNewLabel_2() {
		if (lblNewLabel_2 == null) {
			lblNewLabel_2 = new JLabel("60초 내에 랜덤으로 나오는 음식사진을 보시고");
