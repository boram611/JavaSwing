...
public class PanelGame2 extends JPanel {
	...
	private JLabel lbl2;
	private JLabel lbl3;
	private Image img_1 = new ImageIcon(PanelGame2.class.getResource("/res/score1.png")).getImage().getScaledInstance(45, 45, Image.SCALE_SMOOTH);
	private Image img_2 = new ImageIcon(PanelGame2.class.getResource("/res/score2.png")).getImage().getScaledInstance(45, 45, Image.SCALE_SMOOTH);
	private Image img_3 = new ImageIcon(PanelGame2.class.getResource("/res/score3.png")).getImage().getScaledInstance(45, 45, Image.SCALE_SMOOTH);
	private Image img = new ImageIcon(PanelGame2.class.getResource("/res/a.png")).getImage().getScaledInstance(65, 65, Image.SCALE_SMOOTH);
		...
		if (pnlBtnRul == null) {
			...
			pnlBtnRul.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					GameRul2 gameRul2 = new GameRul2();
					gameRul2.setVisible(true);
				}
				@Override
	...
	private JPanel getPnlBtnGame() {
		if (pnlBtnGame == null) {
			...
			pnlBtnGame.addMouseListener(new MouseAdapter() {
				@Override
				public void mouseClicked(MouseEvent e) {
					GameMain2 gameMain2 = new GameMain2();
					gameMain2.setVisible(true);
				}
				@Override
				public void mouseEntered(MouseEvent e) {
	...
	private JLabel getLblNewLabel_3() {
		if (lblNewLabel_3 == null) {
			lblNewLabel_3 = new JLabel("인물/ 사물 퀴즈 순위");
