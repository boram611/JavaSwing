...
public class admin_Pig extends JFrame {
	...
	//DB to Table
		private void SearchAction(){
			PigDbAction dbAction = new PigDbAction();
		...
		private void insertAction(){
			...
			PigDbAction dbaction = new PigDbAction(answer, input);
		...
		private void TableClick() {
	        ...
	        PigDbAction dbAction = new PigDbAction(wkSequence);
	...
	//*************************************
		...
		private void DeleteAction() {
			...
			PigDbAction dbAction = new PigDbAction(code);
		...
		private void UpdateAction() {
			...
			PigDbAction dbAction = new PigDbAction(code, answer, input);	// 어떤 정보를 수정할지 모르므로 모두 선언 해주기 
	...
	private JLabel getLblImage() {
		if (lblImage == null) {
			...
			lblImage.setHorizontalAlignment(SwingConstants.CENTER);
			lblImage.setBounds(383, 251, 371, 276);
		}
		return lblImage;
	}
	private JLabel getLblNewLabel() {
		if (lblNewLabel == null) {
			lblNewLabel = new JLabel("돼지력 테스트 관리");
			lblNewLabel.setForeground(Color.WHITE);
			lblNewLabel.setFont(new Font("Lucida Grande", Font.BOLD, 20));
			lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
			lblNewLabel.setBounds(124, 6, 581, 90);
		}
		return lblNewLabel;
	}
